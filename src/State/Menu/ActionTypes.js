...
export const CLEAR_MENU_SEARCH = 'CLEAR_MENU_SEARCH';

export const GET_TOP_MEALS_REQUEST = 'GET_TOP_MEALS_REQUEST';
export const GET_TOP_MEALS_SUCCESS = 'GET_TOP_MEALS_SUCCESS';
export const GET_TOP_MEALS_FAILURE = 'GET_TOP_MEALS_FAILURE';
