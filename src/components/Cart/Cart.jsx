        ...
        <section className=' lg:w-[70%] flex justify-center px-5 pb-10  lg:pb-0'>
          <div>
            ...
            <div className=' flex gap-5 flex-wrap justify-center'>
              {auth.user?.addresses?.map((item) => <AddressCard key={item.id} handleSelectAddress={createOrderUsingSelectedAddress} item={item} showButton={true} />)}
